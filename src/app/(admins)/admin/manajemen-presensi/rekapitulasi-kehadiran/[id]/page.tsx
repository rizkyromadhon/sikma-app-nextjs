...
export default function PresensiDetailPage() {
  ...
  return (
    <div className="w-full mx-auto py-10 px-12">
        ...
        <table className="min-w-full text-sm border rounded-md">
          <thead className="bg-muted text-muted-foreground">
            <tr>
              ...
              <th className="p-2 text-left">Ubah</th>
            </tr>
          </thead>
          <tbody>
            {loading ? (
              ...
              presensi.map((p) => (
                <tr key={p.id} className="border-t">
                  <td className="p-2">{format(parseISO(p.waktu_presensi), "dd/MM/yyyy")}</td>
                  <td className="p-2">{format(parseISO(p.waktu_presensi), "HH:mm:ss")}</td>
