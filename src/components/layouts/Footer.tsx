...
export default function Footer() {
  return (
    <>
      <footer className="w-full hidden md:block border-t dark:border-gray-800 py-6 px-4 md:px-8 text-center text-sm text-muted-foreground bg-white dark:bg-black">
